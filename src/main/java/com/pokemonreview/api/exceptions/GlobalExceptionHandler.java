...
@ControllerAdvice // Need this annotation in the GlobalExceptionHandler which serves as an interceptor on the exceptions before the exceptions actually happen
